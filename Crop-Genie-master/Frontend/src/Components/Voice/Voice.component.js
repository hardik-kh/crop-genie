...
const Voice = () => {
    ...
    return (
        <>
            <div className=" bg-gfptrn bg-no-repeat bg-cover h-[100vh] bg-[#57AC49]">
                <div className="w-full  pr-5 h-full place-items-center">
            ...
            <Header /> */}
                    <section className="text-gray-600 body-font right-3 bottom-8 py-[20vh] flex items-center justify-center gap-[10vw]">
                        <div>
                            ...
                            <textarea className="w-[40vw] h-[40vh]  font-bold font-ss bg-white rounded-lg border-2 border-gray-300 focus:outline-none focus:border-[green] text-base px-4 py-2 resize-none leading-6 transition-colors duration-200 ease-in-out" placeholder="Type your Query" onChange={(e) => { setQuery(e.target.value); }} />
                        ...
                        <div>
                            ...
                            <textarea className="w-[40vw] h-[50vh] bg-[#cfcfcf] rounded-lg border-2 border-gray-300 focus:outline-none focus:border-[green] text-base px-4 py-2 resize-none
                             leading-6 transition-colors duration-200 ease-in-out font-bold" placeholder="Solution" value={log} />
                        </div>
                    </section>
                </div>
            </div>
