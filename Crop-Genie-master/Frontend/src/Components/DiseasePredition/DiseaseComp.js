...
function DiseaseComp() {
    ...
    return (
        <div>
            ...
            <Navbar />
            <div className=' w-[100vw] h-[100vh]  flex justify-between bg-wfptrn bg-[#2e7a22] bg-no-repeat bg-cover rounded-xl px-8' >

                <form onSubmit={handleSubmit} className="flex h-[77vh] bg-gray-400 bg-clip-padding backdrop-filter
                 backdrop-blur-sm bg-opacity-20 border border-gray-100
                    rounded-xl my-[18.5vh] w-[40vw] justify-center py-2 ">
                    <div>
